...
import time  # Import time module for creating intervals

# Initialize pygame for playing warning sounds
pygame.mixer.init()
...
def video_frame_callback(frame):
    global last_warning_time  # Declare last_warning_time as global variable
